...
RSpec.describe 'user index page tests', type: :system do
  before(:each) do
    @user1 = User.create(name: 'chris', photo: 'https://images3.alphacoders.com/690/690494.jpg', bio: 'student',
                         posts_counter: 3)
    @user2 = User.create(name: 'ben', photo: 'https://images3.alphacoders.com/690/690494.jpg', bio: 'Explorer',
                         posts_counter: 7)
    @user3 = User.create(name: 'laila', photo: 'https://images3.alphacoders.com/690/690494.jpg', bio: 'consultant',
                         posts_counter: 15)
  end
