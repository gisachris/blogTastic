...
RSpec.describe "User Post Index View Testing", type: :system do
  before(:all) do
    @user = User.create(name: 'chris', photo: 'https://images3.alphacoders.com/690/690494.jpg', bio: 'student', posts_counter: 0)

    @post1 = Post.create(author: @user, title: 'first post', text: 'This is my first post', comments_counter:0, likes_counter:0)
    @post2 = Post.create(author: @user, title: 'second post', text: 'This is my second post', comments_counter:0, likes_counter:0)
    @post3 = Post.create(author: @user, title: 'third post', text: 'This is my third post', comments_counter:0, likes_counter:0)

    @comment_1 = Comment.create(post: @post1, author: @user, text: 'first comment!' )
    @comment_2 = Comment.create(post: @post1, author: @user, text: 'second comment!' )
    @comment_3 = Comment.create(post: @post1, author: @user, text: 'Third comment!' )
  end
